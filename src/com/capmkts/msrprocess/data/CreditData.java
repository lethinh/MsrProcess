...
/**
 * CreditData - CSV file Fields. 
 * @author Rama Yerramilli
 *
 */

@Entity
@Table(name = "[CoIssue_Test].[dbo].[CreditData]")
public class CreditData implements Serializable {
	...
	@Transient
	public boolean isMandateCompleted = false;
	
	public boolean getMandateCompleted() {
		return isMandateCompleted;
	}

	public void setMandateCompleted(boolean isMandateCompleted) {
		this.isMandateCompleted = isMandateCompleted;
	}
